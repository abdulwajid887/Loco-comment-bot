...
def Comment(linkName, array_comment):
    ...
    if live_session:
            ...
            if str(liveComment) == "nan":
                ...
                try:
                    ...
                    try:
                        ...
                        print("\n170: Exception on posting comment")
                        print(epc)
                        print('----------------------------------')
                    ...
                    print("\n176: Exception on writting comment")
                    print(ewc)
                    print('----------------------------------')
                    if counter_exception > 4:
                        break
        ...
        print("187: Live Session is False")
    # sleep(60)
    # driver.quit()
...
if __name__ == "__main__":
    ...
    while col_name=="":
        try:
            ...
            print('208: Error in Column Name of comment')

    if Link_url =="":
        print("211: Please attach URl to the Link")
    elif col_name == "":
        print("213: Please attach name of the column")
    else:
        # try:
            ...
            try:
                ...
                try:
                    ...
                    Comment(new_url, list_of_comments)
                        ...
                        print('246: Error in main try except')
                        print(emte)
                        print('----------------------------------')
            except:
                print('250: exception in main second except')